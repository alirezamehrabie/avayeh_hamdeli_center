...
class EditGuardian extends Component
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'insurance_type_id' => ['nullable', Rule::requiredIf(fn () => $this->toBoolean($this->insurance_status)), 'exists:insurance_types,id'],
            ...
            'any_family_employed_description' => ['nullable', Rule::requiredIf(fn () => $this->toBoolean($this->any_family_employed)), 'string', 'max:500'],
            'has_vehicle' => 'nullable|boolean',
            'vehicle_type_id' => ['nullable', Rule::requiredIf(fn () => $this->toBoolean($this->has_vehicle)), 'exists:vehicle_types,id'],
            'vehicle_ownership_type' => ['nullable', Rule::requiredIf(fn () => $this->toBoolean($this->has_vehicle)), 'in:personal,company,rented'],
