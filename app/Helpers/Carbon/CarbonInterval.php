...
use App\Helpers\Carbon\Constants\UnitValue;
use App\Helpers\Carbon\Exceptions\BadFluentConstructorException;
use App\Helpers\Carbon\Exceptions\BadFluentSetterException;
use App\Helpers\Carbon\Exceptions\InvalidCastException;
use App\Helpers\Carbon\Exceptions\InvalidFormatException;
use App\Helpers\Carbon\Exceptions\InvalidIntervalException;
use App\Helpers\Carbon\Exceptions\OutOfRangeException;
use App\Helpers\Carbon\Exceptions\ParseErrorException;
use App\Helpers\Carbon\Exceptions\UnitNotConfiguredException;
use App\Helpers\Carbon\Exceptions\UnknownGetterException;
use App\Helpers\Carbon\Exceptions\UnknownSetterException;
use App\Helpers\Carbon\Exceptions\UnknownUnitException;
use App\Helpers\Carbon\Traits\IntervalRounding;
use App\Helpers\Carbon\Traits\IntervalStep;
use App\Helpers\Carbon\Traits\LocalFactory;
use App\Helpers\Carbon\Traits\MagicParameter;
use App\Helpers\Carbon\Traits\Mixin;
use App\Helpers\Carbon\Traits\Options;
use App\Helpers\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
use DateTime;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface, UnitValue
{
     ...
     *
     * @return static
     *@throws \App\Helpers\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @example
     * ```
     ...
     *
     * @param \App\Helpers\Carbon\Carbon|\DateTimeInterface|mixed $start
     * @param \App\Helpers\Carbon\Carbon|\DateTimeInterface|mixed $end
     *
     * @return static
     */
