...
namespace App\Helpers\Carbon\Traits;

use App\Helpers\Carbon\Carbon;
use App\Helpers\Carbon\CarbonImmutable;
use App\Helpers\Carbon\CarbonInterface;
use App\Helpers\Carbon\Exceptions\InvalidDateException;
use App\Helpers\Carbon\Exceptions\InvalidFormatException;
use App\Helpers\Carbon\Exceptions\InvalidTimeZoneException;
use App\Helpers\Carbon\Exceptions\OutOfRangeException;
use App\Helpers\Carbon\Exceptions\UnitException;
use App\Helpers\Carbon\Month;
use App\Helpers\Carbon\Translator;
use App\Helpers\Carbon\WeekDay;
use Closure;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat(string $format, string $time, $timezone = null): ?static
    {
        ...
        /** @var \App\Helpers\Carbon\CarbonImmutable|\App\Helpers\Carbon\Carbon|null $mock */
