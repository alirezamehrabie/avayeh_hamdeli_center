...
>
    ...
    <nav x-data="{ openMenu: '{{ $defaultOpenMenu }}' }" @click="if ($event.target.closest('[data-dashboard-section-link]')) closeSidebarOnMobile()" class="flex-1 space-y-2">
        @if($dashboardMode)
            <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'overview' })"
            ...
            <div>
                ...
                <div x-show="openMenu === 'people'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                    @if($dashboardMode)
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'people-list' })"
                        ...
                        @can('people-register')
                            <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'person-create' })"
                            ...
                            <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'people-fast-create' })"
                        ...
                        @can('people-delete')
                            <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'people-block-list' })"
            ...
            @if($dashboardMode)
                <div>
                    ...
                    <div x-show="openMenu === 'social-workers'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'social-workers-list' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'social-worker-create' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'social-workers-block-list' })"
            ...
            @if($dashboardMode)
                <div>
                    ...
                    <div x-show="openMenu === 'guardians'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'guardians-list' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'guardians-block-list' })"
            ...
            @if($dashboardMode)
                <div>
                    ...
                    <div x-show="openMenu === 'services'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'service-list' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'service-delivery' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'service-management' })"
            ...
            @if($dashboardMode)
                <div>
                    ...
                    <div x-show="openMenu === 'activities'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'activity-list' })"
                        ...
                        @can('full-access')
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'activity-definition' })"
        ...
        @if($dashboardMode)
            <div>
                ...
                <div x-show="openMenu === 'child-supporter'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                    <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'child-supporter-sponsor-registration' })"
                    ...
                    <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'child-supporter-sponsor-list' })"
            ...
            <div>
                ...
                <div x-show="openMenu === 'special-features'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                    <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'special-features-id-card-scanner' })"
        ...
        @if($dashboardMode && auth()->user()?->can('access-admin-panel'))
            <div>
                ...
                <div x-show="openMenu === 'reports'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                    ...
                    @can('full-access')
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'advanced-beneficiary-report' })"
                    ...
                    @endcan
                    @can('full-access')
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'advanced-supervisor-report' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'advanced-social-worker-report' })"
                    ...
                    @endcan
                    <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'advanced-service-report' })"
                    ...
                    <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'advanced-operator-report' })"
        ...
        @if($dashboardMode)
            <div>
                ...
                <div x-show="openMenu === 'system-settings'" x-collapse.duration.250ms class="mt-2 mr-8 space-y-1">
                    @can('full-access')
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'system-settings-user-definition' })"
                        ...
                        <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'system-settings-user-list' })"
                    ...
                    @endcan
                    <button type="button" data-dashboard-section-link wire:click="$dispatch('open-dashboard-section', { section: 'system-settings-user-account' })"
