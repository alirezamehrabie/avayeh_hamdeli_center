<header class="flex items-center justify-between gap-4 px-6 py-4 bg-white border-b shadow-sm">
    <div class="flex items-center gap-4">
        ...
        <button type="button" x-ref="sidebarToggle" @click="toggleSidebar()" :aria-expanded="sidebarOpen.toString()" aria-controls="dashboard-sidebar" class="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-indigo-100 bg-indigo-50 text-indigo-700 shadow-sm transition duration-200 hover:-translate-y-0.5 hover:bg-indigo-100 hover:shadow-md focus:outline-none focus:ring-4 focus:ring-indigo-100" aria-label="نمایش یا پنهان‌سازی منو">
