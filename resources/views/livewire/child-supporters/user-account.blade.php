        ...
        <div class="grid gap-4 md:grid-cols-2">
            <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                ...
                <div class="mt-3 space-y-2 text-sm">
                    ...
                    <div class="flex items-center justify-between rounded-lg bg-slate-50 px-3 py-2"><span class="text-slate-500">نقش</span><span class="font-semibold text-slate-700">حامی کودک</span></div>
                </div>
            </div>
