...
>
    ...
    {{-- Registration date (service-level, required): kept near the top so it isn't
         pushed off-screen as workers are added (Item 13). --}}
    <div>
    ...
    {{-- Description (optional): stays below the worker list. --}}
    <div>
