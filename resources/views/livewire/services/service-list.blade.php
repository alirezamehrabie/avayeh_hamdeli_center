                        ...
                        <div class="flex min-w-0 flex-1 flex-col gap-4 xl:flex-row xl:items-center xl:gap-3">
                            ...
                            <div class="xl:flex-[0.7]">
                                ...
                                <button
                                    ...
                                    class="group mt-1 inline-flex items-center gap-2 rounded-full border border-cyan-200 bg-cyan-50 px-3 py-1.5 text-xs font-black text-cyan-800 shadow-sm shadow-cyan-950/5 transition hover:-translate-y-0.5 hover:border-cyan-300 hover:bg-white hover:text-cyan-900 hover:shadow-md focus:outline-none focus:ring-4 focus:ring-cyan-100 active:translate-y-0"
                                    title="مشاهده عملکرد مددکاران"
                                    aria-label="مشاهده عملکرد مددکاران"
                                >
                                    <span class="inline-flex h-5 w-5 items-center justify-center rounded-full bg-cyan-600 text-[10px] font-black text-white transition group-hover:scale-110">
            ...
            <div class="max-h-[78vh] overflow-y-auto px-4 py-5 sm:px-6">
                ...
                <template x-if="!(workersSummary?.workers?.length)">
                    <div class="rounded-[28px] border border-dashed border-slate-300 bg-slate-50 px-4 py-12 text-center">
                        ...
                        <p class="mt-1 text-xs text-slate-400">پس از تخصیص سهمیه، وضعیت مصرف و ظرفیت باقی‌مانده در همین بخش نمایش داده می‌شود.</p>
                    </div>
                </template>
            </div>
        </div>
