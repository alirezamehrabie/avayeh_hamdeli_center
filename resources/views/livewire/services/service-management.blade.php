        ...
        <div class="space-y-4 px-4 py-4">
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-4">
                <div class="mb-4 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <h2 class="text-base font-bold text-slate-800">آرشیو موارد حذف‌شده</h2>
                        <p class="text-xs text-slate-500">نام‌های خدمت و دسته‌بندی‌های حذف‌شده برای بازیابی امن نگهداری می‌شوند.</p>
                    </div>
                    <span class="inline-flex w-fit items-center rounded-full bg-slate-100 px-2 py-0.5 text-[11px] font-semibold text-slate-500">
                        {{ $archivedServiceNames->count() + $archivedServiceCategories->count() }} مورد
                    </span>
                </div>
