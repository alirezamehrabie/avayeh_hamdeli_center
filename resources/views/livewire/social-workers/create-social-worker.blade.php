<div>
    <div class="card shadow-sm">
        {{-- هدر کارت با رنگ آبی (متمایز از صورتی مددجو برای تشخیص بهتر کاربر) --}}
        <div class="card-header bg-primary text-white">
            <h3 class="mb-0">فرم ثبت‌نام مددکار جدید</h3>
        </div>
        ...
        <div class="card-body">
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="mb-5">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control text-center" maxlength="10" wire:model.blur="national_id">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="p-3 border rounded bg-white text-center shadow-sm">
                                ...
                                <input type="number" class="form-control text-center fw-bold text-primary" wire:model.blur="covered_people_count">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 border rounded bg-white text-center shadow-sm">
                                <label class="small text-muted d-block mb-1">تعداد خانوار تحت پوشش</label>
                                <input type="number" class="form-control text-center fw-bold text-primary" wire:model.blur="covered_households_count">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="p-3 border rounded bg-white text-center shadow-sm">
                ...
                <div class="d-flex justify-content-end gap-2 mt-4 mb-5">
                    <button type="button" class="btn btn-outline-secondary px-4" onclick="history.back()">انصراف</button>
                    <button type="submit" wire:loading.attr="disabled" class="btn btn-primary px-5 fw-bold">
